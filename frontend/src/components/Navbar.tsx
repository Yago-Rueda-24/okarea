...
export default function Navbar({ transparent = true }: NavbarProps) {
  ...
  if (transparent) {
    return (
      <nav className="fixed top-0 inset-x-0 z-50 transition-all duration-300 bg-transparent text-[#FEEBE7] font-fraunces">
        ...
        {/* Desktop Layout: left-aligned logo and links, right-aligned social icons */}
        <div className="hidden md:flex w-full px-6 md:px-12 h-20 justify-between items-center font-medium">
          {/* Left Side: Brand Logo + Navigation Links */}
          <div className="flex items-center space-x-6 sm:space-x-8 md:space-x-12">
            <Link
              to="/"
              className="text-2xl md:text-3xl font-semibold tracking-widest uppercase transition-opacity duration-300 hover:opacity-80 text-current pr-2 sm:pr-4 leading-none"
            >
        ...
        {/* Mobile Layout: Hamburger + OkArea on the left, social icons on the right */}
        <div className="md:hidden w-full px-6 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link
              ...
              className="text-xl font-semibold tracking-widest uppercase transition-opacity duration-300 hover:opacity-80 text-current"
            >
              OkArea
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 w-full bg-[#faa18f]/95 border-t border-[#FEEBE7]/15 py-6 px-8 flex flex-col space-y-5 font-medium shadow-lg transition-all duration-300 animate-slideDown">
            <Link
              to="/bolsos"
              onClick={() => setIsMobileMenuOpen(false)}
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-[#FEEBE7] text-[#faa18f] font-fraunces">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-[#FEEBE7] border-t border-[#feebe7]/10 py-6 px-8 flex flex-col space-y-5 font-medium shadow-lg transition-all duration-300 animate-slideDown">
          <Link
            to="/bolsos"
            onClick={() => setIsMobileMenuOpen(false)}
